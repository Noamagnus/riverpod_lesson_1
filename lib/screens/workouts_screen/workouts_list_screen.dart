...
import 'package:my_first_riverpod/screens/workouts_screen/action_screen.dart';
import 'package:my_first_riverpod/screens/workouts_screen/create_wokout_screen.dart';
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        ref
                                            .read(actionWorkoutProvider.notifier)
                                            .setInitialTimerDuration(workout);
                                  ...
                                  child: Column(
                                    children: workout.listOfExercises.map((exercise) {
                                      if (exercise.exerciseType == ExerciseType.repeaters) {
                                        ...
                                        return Text(
                                            'Estimated time is ${exercise.estimatedTime} sec');
                                      } else {
