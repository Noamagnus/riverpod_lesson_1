...
class _$SettingsTearOff {
  ...
  _Settings call({bool displayDetails = true}) {
    return _Settings(
...
class _$_Settings extends _Settings {
  const _$_Settings({this.displayDetails = true}) : super._();
  ...
  @override
  String toString() {
    return 'Settings(displayDetails: $displayDetails)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(displayDetails));
...
abstract class _Settings extends Settings {
  const factory _Settings({bool displayDetails}) = _$_Settings;
